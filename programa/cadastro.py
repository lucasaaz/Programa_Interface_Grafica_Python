...
class App_Cadastro(ctk.CTk, bancoDados.BancoDados, imprimir.Imprimir):
    ...
    def pegarId(self):
        ...
        self.comando = f'SELECT * FROM curso.cadastro1'
    ...
    def tela_cadastro(self):
        ...
        self.lb_cebecalho = ctk.CTkLabel(self.frame_cabecalho, text="SISTEMA CURSO", text_color='#292929', font=('Georgia', 35)).place(x=300, y=5)
        ...
        self.curso = ctk.CTkComboBox(self.frame_curso, values=["", "", ""], width=438, dropdown_text_color='#999999', dropdown_font=("Century Gothic bold", 12), font=("Century Gothic bold", 13), button_color='#E06F12', button_hover_color='#D96200', corner_radius=10)
        ...
        def pegar_cep():
            try:
                ...
                messagebox.showinfo('Curso ', 'Erro! CEP está errado.') 
